...
/**
*The console.  log() is a funcgtion in JavaScript which is used to print any kind of 
variables defined before in it or to just print any message that needs to be displayed 
to the user.
*/

//String

const name = "Christopher Davis";
...
var favoriteMovie = "My favorite movie is Doctor Doo Little";
document.write("Favorite Movie");
